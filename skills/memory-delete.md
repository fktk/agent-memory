...
```bash
~/.local/bin/memory-delete.sh "<ファイル名またはタイトル>"
```
...
```bash
# ファイル名で指定
~/.local/bin/memory-delete.sh "avoid-nested-ternary.md"

# .md 省略可
~/.local/bin/memory-delete.sh "avoid-nested-ternary"

# タイトルの一部であいまい検索
~/.local/bin/memory-delete.sh "nested ternary"
```
